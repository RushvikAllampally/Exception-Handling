...
public class StudentUtil {
	...
	public static double[] calculateGPA (int[] studentIdList, char[][] studentsGrades) throws MissingGradeException {
        ...
        if(studentIdList.length !=  studentsGrades.length){
            throw new IllegalArgumentException("studentsidList & studentsGrades are out-of-sync.studentIdList.length: "+ studentIdList.length + ",studentsGrades.length: "+ studentsGrades.length);
        }
